...
export const faqItems: FaqItem[] = [
  {
    ...
    answer: "네, No-Rinse® 제품의 모든 성분은 글루텐 프리입니다.",
  },
  {
    id: "shampoo-amount",
    question: "No-Rinse® 샴푸는 얼마나 사용해야 하나요?",
    answer:
      "No-Rinse® 샴푸 사용법이 궁금하시다면, 머리카락이 완전히 적셔질 때까지 바른 뒤 마사지하고, 수건으로 충분히 닦아 최대한 수분을 제거하세요.",
  },
  {
    id: "shampoo-cap-microwave",
    question: "전자레인지에서 No-Rinse® 샴푸 캡을 어떻게 데우나요?",
    answer:
      "포장을 열어 환기시킨 뒤 캡을 포장 안에 둔 채 15초 이내로만 데우세요. 머리에 씌우기 전에 과도하게 뜨겁지 않은지 확인하세요. 뜨거운 샴푸 캡은 절대 사용하지 마세요.",
  },
  {
    id: "perm",
  ...
  },
  {
    ...
    answer:
      "네, 사람에게 사용하는 방법과 동일하게 따르세요. 무자극 제품이 아니므로 얼굴 주변 사용 시 주의하세요.",
  },
  {
    id: "body-bath-vs-wash",
    question: "바디 바스(Body Bath)와 바디 워시(Body Wash)의 차이는 무엇인가요?",
    answer:
      "No-Rinse® 바디 바스는 농축형입니다(1oz를 32oz 물에 희석). No-Rinse® 바디 워시는 병에서 바로 사용할 수 있습니다.",
  },
];
